...
RUN echo $GCP_CREDENTIALS | gcloud auth activate-service-account $SA_ACCOUNT --key-file=- && gsutil cp gs://015ba1db99263839-source-bucket/data.txt gs://015ba1db99263839-destination-bucket/
